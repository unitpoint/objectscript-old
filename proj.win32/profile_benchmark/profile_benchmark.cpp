...
#define OPCODE_NAME(name) case Core::name: return (#name)+3 // skip OP_
		...
		OPCODE_NAME(OP_NUMBER_LOGIC_EQ);
		OPCODE_NAME(OP_NUMBER_LOGIC_GREATER);
		OPCODE_NAME(OP_NUMBER_LOGIC_GE);

		OPCODE_NAME(OP_NUMBER_BIT_AND); // &
		OPCODE_NAME(OP_NUMBER_BIT_OR);  // |
		OPCODE_NAME(OP_NUMBER_BIT_XOR); // ^

		OPCODE_NAME(OP_NUMBER_ADD); // +
		OPCODE_NAME(OP_NUMBER_SUB); // -
		OPCODE_NAME(OP_NUMBER_MUL); // *
		OPCODE_NAME(OP_NUMBER_DIV); // /
		OPCODE_NAME(OP_NUMBER_MOD); // %
		OPCODE_NAME(OP_NUMBER_LSHIFT); // <<
		OPCODE_NAME(OP_NUMBER_RSHIFT); // >>
		OPCODE_NAME(OP_NUMBER_POW); // **

		OPCODE_NAME(OP_NUMBER_ADD_LC); // +
		OPCODE_NAME(OP_NUMBER_SUB_LC); // -

		OPCODE_NAME(OP_NUMBER_ADD_LL); // +
		OPCODE_NAME(OP_NUMBER_SUB_LL); // -
